...
func Login(c *fiber.Ctx) error {
	...
	if passErr != nil {
		// return c.Status(http.StatusInternalServerError).JSON(responses.APIResponse{Status: http.StatusInternalServerError, Message: "error", Data: &fiber.Map{"data": passErr.Error()}})
